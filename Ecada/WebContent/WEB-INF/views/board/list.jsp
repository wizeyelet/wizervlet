...
$(document).ready(function(){
	...
	$('#btnSearch').click(function(){
		...
		var url = '/free/fList.do?typeSeq=2&searchType='+searchType+'&searchText='+searchText;
...
<body>
	...
	<div class="contain-wrapp">
	    <div class="container">
	        <div class="row">
	            <div class="col-xs-12">
	                <!-- <h3 >자유게시판</h3> --><!-- style="color:#f0f0f0" -->
	                <table class="table table-bordered">
	                    ...
	                    <thead>
	                        <tr>
	                            ...
	                            <th class="text-center" style="background-color:#a10f2b; color:#FFFFFF;">썸네일</th>
	                    ...
	                    <tbody>
	                    	<c:forEach items="${list}" var="i">
	                    		<tr>
		                            ...
		                            <td align="center" valign="middle">
		                            	<c:choose>
											<c:when test="${ !empty i.fileIdx }">
												<img src="<c:url value='/free/download.do?fileIdx=${i.fileIdx}'/>" height="40" width="60" alt=""/>
											</c:when>
											<c:otherwise>
		                            ...
		                            <td valign="middle"><a href="javascript:movePage(this, '/free/read.do?typeSeq=2&amp;boardSeq=${i.boardSeq }')">${i.title}</a></td>
				...
				<td align="right" valign="middle">
					<c:if test='${sessionScope.memberId != null }'>
						    <!-- <div class="col-md-12 text-right"> -->
						    	<a href="javascript:movePage(this, '/free/goWrite.do')">
