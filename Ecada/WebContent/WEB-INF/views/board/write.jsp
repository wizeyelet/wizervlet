				...
				<div class="col-md-12">
					...
					<input type="hidden" name="memberIdx" value="${sessionScope.memberIdx}"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea id="editor" class="form-control textarea-e" rows="15" name="contents"
						...
						<td align="right"><a href="javascript:movePage(this, '/free/fList.do?typeSeq=2')"><button type="button" class="btn-e btn-e-primary">목록</button></a></td>
						</tr>
						</table>
						</div>
					</form>
