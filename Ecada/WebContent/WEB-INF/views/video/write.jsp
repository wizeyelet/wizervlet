...
<script type="text/javascript">
	...
	function doWrite(){
	    ...
	    var ajaxReq = $.ajax({
	    	url : "<c:url value='/video/write.do' />",
	          data : formData,
	          type : 'POST',
	          dataType : "text",
	          processData : false,
	          ...
	          success : function (result, textStatus, XMLHttpRequest) {
	              ...
	              if(result == 1){
	                  alert("게시글이 작성되었습니다.");
	                  movePage(this, "/video/goNlp.do?typeSeq=3", "pageName=free");
	              } else {
	            	  console.log("1");
	                 alert("게시글 작성 에러\n관리자에게 문의바랍니다.");
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<input type="hidden" name="memberIdx" value="${sessionScope.memberIdx}"/>
						...
						<div class="form-group">
							<label for="input12" class="col-sm-3">영상 주소</label>
						...
						<td align="right"><a href="javascript:movePage(this, '/video/vList.do?typeSeq=3')"><button type="button" class="btn-e btn-e-primary">목록</button></a></td>
						</tr>
						</table>
						</div>
					</form>
